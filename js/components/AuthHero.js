function HeroSide() {
  return {
    view: () => {
      ...
      const isRegister = m.route.get() === "/registro";

      return m("div", { class: "hero-side" }, [
        m("img", {
        ...
        m("div", { class: "hero-content" }, [
          ...
          m("p", {
            ...
            isRegister
              ? "Únete a la mayor comunidad de pádel y empieza a reservar tus pistas favoritas"
