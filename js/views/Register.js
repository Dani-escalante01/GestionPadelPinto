        ...
        m("form", { onsubmit: RegisterActions.register }, [
          ...
          m("div", { class: "form-group" }, [
            ...
            m("input", {
              ...
              value: RegisterState.form.nombre,
              oninput: (e) => RegisterActions.setInput("nombre", e.target.value),
            }),
          ]),
          ...
          m("div", { class: "form-group" }, [
            ...
            m("input", {
              ...
              oninput: (e) => RegisterActions.setInput("email", e.target.value),
            }),
          ]),
          ...
          m("div", { class: "form-group" }, [
            ...
            m("input", {
              ...
              oninput: (e) => RegisterActions.setInput("password", e.target.value),
            }),
          ]),
          ...
          m("div", { class: "form-group" }, [
            ...
            m(
              "select",
              {
                class: "input-field",
                required: true,
                value: RegisterState.form.nivel,
...
const RegisterView = {
  view: () => {
    // Aplicar el tema global si existe
      ...
      m("div", { class: "form-side" }, [
        m("div", { class: "navbar-floating" }, [
          m(
            ...
            {
              href: "#!/",
              style: "text-decoration:none; color:var(--text-muted); font-size:12px; font-weight:700;",
        ...
        m("a", {
          ...
          m(
            "div",
            {
              style: "background:var(--primary); color:white; width:30px; height:30px; border-radius:6px; display:flex; align-items:center; justify-content:center; font-weight:bold;",
            },
            "P",
          ),
